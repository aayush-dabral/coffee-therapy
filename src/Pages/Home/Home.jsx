    ...
    <div className="font-poppins text-white">
      ...
      >
        <div className="absolute left-[8%] sm:left-[10%] top-[35%] sm:top-[48%] transform -translate-y-1/2">
          <div className="text-[80px] sm:text-[120px] leading-none font-anton">
            COFFEE
            <br />
            THERAPY
            <br />
          ...
          <div className="text-[16px] sm:text-[23.6px] mt-2 font-medium">
            POURING PASSION, BREWING PURPOSE
          </div>
        </div>
        <button className="absolute left-1/2 bottom-[14%] sm:bottom-[8%] transform -translate-x-1/2 px-6 py-[6px] text-[18px] border-2 border-white">
          Explore Now
        </button>
      </div>
      ...
      <div className="flex flex-col sm:flex-row justify-between sm:items-center w-[90%] sm:w-[80%] mx-auto mt-12">
        <div className="sm:w-[58%] text-white">
          <div className="font-anton text-[49.44px] sm:text-[74.16px] ">
            OUR STORY
          </div>
          <div className="w-[32%] h-[2px] bg-white mt-4" />

          <img src={ourStory} className=" sm:hidden size-[500px mt-8" />
          <div className="text-[16.28px] text-pretty font-poppins mt-8 leading-relaxed ">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-center w-[80% mx-auto mt-16">
        <div className="lg:w-[50%] w-full">
          <div className="md:hidden font-anton text-[49.44px] md:text-[74.16px] my-4 text-center">
            OUR BESTSELLERS
          </div>
          <img src={bestsellersCover} className="size-[500px w-full" />
        </div>
        <div className="w-[90%] lg:w-[50%] px- text-white mt-8 md:mt-0">
          <div className="hidden md:block font-anton text-[49.44px] md:text-[74.16px] text-center">
            OUR BESTSELLERS
          </div>
          <div className="flex flex-col md:flex-row justify-center items-center md:items-stretch gap-4 px-4">
            <div className="w-[90% md:w-[48%] bg-[#1A1A1A] p-2 pb-8 text-[17.5px flex-1">
          ...
          <div className=" flex justify-center md:justify-end mt-4 px-4">
            <button className="px-8 py-[6px] bg-transparent border-2">
              View All
            </button>
          </div>
        </div>
      ...
      >
        ...
        <div className="w-[80%] sm:w-[90%] hidden sm:flex flex-col items-center md:items-start md:flex-row justify-center gap-8 mt-12">
          <div className="flex flex-col sm:flex-row w-[3 00px] sm:w-[400px] items-center bg-[#1A1A1A]">
          ...
          <div className="flex md:hidden flex-col sm:flex-row xl:flex w-[3 00px] sm:w-[400px] items-center bg-[#1A1A1A]">
        ...
        <button className="mt-12 px-8 py-[6px] bg-transparent border-2">
          View All
        </button>
      </div>
      ...
      >
        <div className="font-anton text-[49.44px] sm:text-[74.16px] leading-none tracking-wide w-[90%] sm:w-[40%]">
          COFFEE CULTURE COLLECTIVE
        </div>
        <div className="text-[15.28px]  sm:text-[17.5px] leading-loose w-[90%] sm:w-[50%] mt-16">
        ...
        <div className="px-2 flex justify-end mt-12">
          <button className="px-4 py-[6px] bg-transparent border-2">
            Join The Community
          </button>
        </div>
      </div>
      ...
      <div className="flex flex-col justify-center items-center w-[90%] md:w-[85%] mx-auto pt-16 md:py-12 md:pb-36">
        <div className="font-anton text-[49.44px] sm:text-[74.16px] text-center leading-none tracking-wide sm:w-[40%]">
          OUR GUESTBOOK
        </div>
        <div className="hidden md:flex justify-center items-end mt-12 text-[15px]">
          <div className="relative flex flex-col items-center bg-[#191919] text-[#938E8E] h-[240px] w-[32%]">
            <img src={quote} className="size-12 mt-8" />
            ...
            <div className="flex flex-col items-center absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-[65%]">
              <img src={rev1} className="size-24" />
              <div className="mt-2">Bijak Kumar</div>
              <div>Yoga Instructor</div>
            </div>
          </div>
          <div className="relative flex flex-col items-center bg-[#1A2C1E] drop-shadow-2xl h-[280px] w-[36%]">
            <img src={quote} className="size-12 mt-8" />
            <div className="mt-6 px-4 text-center text-[17.5px] ">
              "Superb experience! Great vibes, great coffee, great people. 10/10
              would recommend!"
            </div>
            <div className="flex flex-col items-center absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-[65%]">
              <img src={rev2} className="size-24" />
          ...
          <div className="relative flex flex-col items-center bg-[#191919] text-[#938E8E] h-[240px] w-[32%]">
            ...
            <div className="flex flex-col items-center absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-[65%]">
              <img src={rev3} className="size-24" />
      ...
      <div className="flex flex-col justify-center items-center w-[85%] mx-auto py-16 pb-20 text-white">
        <div className="text-center">
          ...
          <div className="text-5xl font-anton mt-3">CONNECT ON INSTAGRAM</div>
          <div className="flex justify-center items-center gap-1 text-xl mt-3">
      ...
      >
        <div className="font-anton text-5xl text-center">
          REACH OUT, LET'S CONNECT
        </div>
        <div className="flex gap-4 items-center bg-white py-[6px] px-2 mt-4 w-[80%] sm:w-[30%]">
